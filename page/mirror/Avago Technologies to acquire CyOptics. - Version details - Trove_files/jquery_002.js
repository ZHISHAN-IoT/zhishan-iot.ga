			...
			if (icon != null) {
				...
				if (typeof icon == 'number') {
					html += '<span title="' + title + '" ' +
						(settings.iconsStyle ? 'class="' + settings.iconsStyle + ' offscreen" ' : '') +
						'style="' + (settings.iconsStyle ? 'display:block;background-position: ' :
						...
						(Math.max(0, settings.iconSize - 16)) + 'px;' : '') + '">' + title + '</span>';
				}
				else {
