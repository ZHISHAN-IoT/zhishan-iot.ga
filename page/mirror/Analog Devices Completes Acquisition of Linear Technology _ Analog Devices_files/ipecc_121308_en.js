...
ADIAssetsPath = ADIAssetsPath || "//assets.analog.com";
//BEGIN Configuration variables
iperceptions.imgRootPath = ADIAssetsPath+"/images/iperceptions/en/";
iperceptions.imgSizeOut = [68, 68];
iperceptions.imgSizeOver = [180, 68];
iperceptions.blockMobile = true;
iperceptions.surveyID = 121308;
iperceptions.langID = 1;
iperceptions.posX = 'right';
iperceptions.posY = 'bottom';
iperceptions.winWidth = 676;
iperceptions.winHeight = 676;
...
iperceptions.launch = function(config) {
    ...
    var w = 0, h = 0, url = "", l = 0, t = 0, vs = iperceptions.viewSize(), 
        sdfc = "7f4b8b35" + "-" + config.surveyID + "-" + "d85f2cf3-d58c-4583-afee-3b720e788828";
    w = iperceptions.winWidth || 676;
    h = iperceptions.winHeight || 676;
