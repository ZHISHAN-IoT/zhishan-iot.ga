	...
	steal.getScriptOptions = function(script){
			...
			if(script){
				...
				if ( src.indexOf('?') !== -1 ) {
                    ...
                    // Also check for presence of versioning for browser cache ( v= ).
					if (commaSplit[0] && commaSplit[0].lastIndexOf('.js') > 0 && commaSplit[0].lastIndexOf('v=') < 0 ) {
					    options.startFile = commaSplit[0];
					} else if (commaSplit[0] && commaSplit[0].lastIndexOf('v=') < 0 ) {
